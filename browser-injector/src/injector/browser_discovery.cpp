...
namespace Injector {
    ...
    std::wstring BrowserDiscovery::ResolvePath(const std::wstring& browserType, const std::wstring& exeName) {
        ...
        if (browserType == L"chrome") {
            ...
            altRegistry = {
                {L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Google Chrome Dev", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Google Chrome Dev", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome Dev\\shell\\open\\command", L""}
            };
        } else if (browserType == L"chrome-canary") {
            altRegistry = {
                {L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Google Chrome Canary", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Google Chrome Canary", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome Canary\\shell\\open\\command", L""}
            };
            ...
            altRegistry = {
                {L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Microsoft Edge Beta", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Microsoft Edge Beta", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\Clients\\StartMenuInternet\\Microsoft Edge Beta\\shell\\open\\command", L""}
            };
        } else if (browserType == L"edge-dev") {
            altRegistry = {
                {L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Microsoft Edge Dev", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Microsoft Edge Dev", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\Clients\\StartMenuInternet\\Microsoft Edge Dev\\shell\\open\\command", L""}
            };
        } else if (browserType == L"edge-canary") {
            altRegistry = {
                {L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Microsoft Edge Canary", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Microsoft Edge Canary", L"InstallLocation"},
                {L"\\Registry\\Machine\\SOFTWARE\\Clients\\StartMenuInternet\\Microsoft Edge Canary\\shell\\open\\command", L""}
            };
